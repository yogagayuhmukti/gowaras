      ...
      <div className="container-fluid justify-content-start-md">
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav">
            ...
            <li className="nav-item">
              <HashLink className="nav-link text-black" to="/konsultasilayanan">
                Konsultasi Layanan
              </HashLink>
            </li>
            <li className="nav-item">
              <HashLink className="nav-link text-black" to="/rujukpindahlokasi">
                Rujuk Pindah Lokasi
              </HashLink>
            </li>
            <li className="nav-item">
            ...
            <li className="nav-item">
              <HashLink className="nav-link text-black" to="/konsultasidokter">
                Konsultasi Dokter
              </HashLink>
            </li>
            <li className="nav-item">
